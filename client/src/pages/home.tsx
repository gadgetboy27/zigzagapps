...
export default function Home() {
  ...
  useEffect(() => {
    ...
    document.title =
      "Swipe Right Apps - Henry Peti | Modern App Developer & Entrepreneur | Portfolio & App Store";

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Swipe Right Apps by Henry Peti - Software Engineer, App Developer & Entrepreneur. Discover cutting-edge mobile apps, web applications, and digital solutions. Buy premium apps and explore innovative development projects.",
      );
    }
  }, []);
      ...
      <footer className="py-12 border-t border-border">
        <div className="container mx-auto px-6">
          <div className="text-center">
            <div className="text-2xl font-bold text-gradient font-mono mb-4">
              Swipe Right NZ
            </div>
            ...
            <p className="text-muted-foreground text-sm">
              © 2025 Swipe Right NZ. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
